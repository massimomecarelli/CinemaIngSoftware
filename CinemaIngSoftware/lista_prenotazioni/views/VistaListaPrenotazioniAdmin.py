...
class VistaListaPrenotazioniAdmin(QWidget):
    ...
    def __init__(self, data=None, parent=None):
        ...
        self.bottone_dettagli_prenotazione.setStyleSheet("background-color: rgb(170,180,255);")
        ...
        #Se è stata passata una data, verrà creato nella finestra un piccolo sommario della situazione del
        #resort in quella data
        if data is not None:
            self.label_stats = QLabel("Statistiche sulle prenotazioni:")
            self.label_stats.setAlignment(Qt.AlignCenter)
            self.label_stats.setStyleSheet("font:  18pt \"Papyrus\";""color: rgb(0,0,255);")
